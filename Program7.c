...
int main()
{
    auto int iValue1=0;   // Variable to input
    auto int iValue2=0;   // Variable to input
    auto int iAns=0;      // Variable to result
    ...
    iAns= Addition(iValue1,iValue2);  // Call to function to perform addition
